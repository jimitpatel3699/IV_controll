    ...
    <div class="row">
        <div class="col-sm-12">
            <center>
                ...
                <div class="h1">Add Admitted Patients Records </div>
            </center>
        </div>
    </div>
...
<div class="form-group">
    ...
    <input type="date" name="admit_date" class="form-control" id="exampleInputPassword1" placeholder="Admit_date" required>
  </div>

  <div class="form-group">
    <label for="exampleInputPassword1">Admit_Time</label>
    <input type="time" name="admit_time" class="form-control" id="exampleInputPassword1" placeholder="Admit_time" required>
  </div>

  <div class="form-group">
    <label for="exampleInputPassword1">Leave_Date</label>
    <input type="date" name="leave_date" class="form-control" id="exampleInputPassword1" placeholder="Leave_date" required>
  </div>

  <div class="form-group">
    <label for="exampleInputPassword1">Leave_Time</label>
    <input type="time" name="leave_time" class="form-control" id="exampleInputPassword1" placeholder="Leave_time" required>
  </div>
...
<div class="row">
    ...
    <?php
        ...
        $sql = "INSERT INTO patients_record(patient_id,patient_name,admit_date,admit_time,leave_date,leave_time,room_no) VALUES ('".$pid."','".$pname."','".$admit_date."','".$admit_time."','".$leave_date."','".$leave_time."','".$roomno."')";
